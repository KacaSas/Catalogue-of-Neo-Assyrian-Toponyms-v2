...
if option == 'Cuneiform signs':
	...
	with st.expander('Notice and sources:', expanded=False):
		...
		st.markdown('– CuneiformComposite.ttf (S. Tinney): http://oracc.museum.upenn.edu/doc/help/visitingoracc/fonts/.<br>– SantakkuM.ttf (S. Vanséveren): https://www.hethport.uni-wuerzburg.de/cuneifont/.<br>– Old Babylonian Freie (Corvin R. Ziegeler): https://refubium.fu-berlin.de/handle/fub188/45271 and https://github.com/crzfub/OB-Freie.<br>– Santakku.ttf (S. Vanséveren): https://www.hethport.uni-wuerzburg.de/cuneifont/.<br>– Assurbanipal.ttf (S. Vanséveren): https://www.hethport.uni-wuerzburg.de/cuneifont/.<br>– Sinacherib.ttf: http://home.zcu.cz/~ksaskova/.', unsafe_allow_html=True)
